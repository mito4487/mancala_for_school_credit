...
def evaluate_1(mancala_seeds):
    eva=mancala_seeds[7]-mancala_seeds[0]+(mancala_seeds[1]+mancala_seeds[2]+mancala_seeds[3]+mancala_seeds[4]+mancala_seeds[5]+mancala_seeds[6]-mancala_seeds[10]-mancala_seeds[11]-mancala_seeds[9]-mancala_seeds[8]-mancala_seeds[12]-mancala_seeds[13])
    return eva
